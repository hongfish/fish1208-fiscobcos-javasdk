...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
  ...
  function create(
    ...
    _log(_isIdExist(_id), "ERC1155Tradable#create: id is exist");
    require(!_isIdExist(_id), "ERC1155Tradable#create: id is exist");
    ids.push(_id);
    creators[_id] = msg.sender;
  ...
  function _isIdExist(uint256 _id) private returns(bool) {
